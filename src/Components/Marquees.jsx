...
function Marquees() {
  ...
  return (
    <div className="w-full relative overflow-hidden mt-16 sm:mt-20 md:mt-28 lg:mt-32 py-12 sm:py-16 md:py-20">
      {images.map((item, index) => (
        <Marque
          key={index}
          item={item}
          direaction={index === 0 ? "left" : "right"} // keeping your prop name to avoid breaking
        />
      ))}
    </div>
  )
